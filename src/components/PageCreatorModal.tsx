          ...
          <div className="pt-3 border-t border-[#1e293b] flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                disabled={isSaving}
                onClick={onClose}
                className="px-4 py-2 bg-[#1e293b] hover:bg-[#334155] text-white font-bold rounded-xl cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={isSaving}
                className="px-6 py-2 bg-sky-500 hover:bg-sky-400 text-black font-bold rounded-xl shadow-[0_0_20px_rgba(56,189,248,0.4)] cursor-pointer active:scale-95 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSaving ? (
                  <>
